      ...
      <div className="relative w-full px-5  md:px-[120px] pt-[50px] md:pt-[80px]">
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="w-full flex flex-col justify-center md:flex-row gap-5 pt-10">
            <Button
              title="Start Now"
              styles="w-full md:w-[130px] py-3 text-white font-bold text-[18px] bg-gradient-to-br from-[#6A36FF] to-[#AC5FE6]  hover:text-[#6A36FE] hover:border hover:border-[#7C51FF] hover:bg-none "
            />
            <Button
              title="Trial"
              styles="w-full md:w-[130px] font-bold text-[18px]  py-3 text-white border border-md "
            />
          </div>
        </div>
      </div>
